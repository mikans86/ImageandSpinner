package com.appstructural.jelovnik15.imageandspinner.preferenc;
...
public class Preferenc extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getFragmentManager().beginTransaction().replace(android.R.id.content, new Preferenc.PrefsFragment()).commit();
    }
